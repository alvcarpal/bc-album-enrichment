...
@Configuration
@EnableJpaRepositories(basePackages = "com.bc.album.infrastructure.db.springdata.repository")
@ConfigurationProperties("spring.datasource")
@NoArgsConstructor
@Getter
@Setter
@EnableJpaAuditing
@EntityScan(basePackages = "com.bc.album.infrastructure.db.springdata.model")
